...
def problem_04(text_size: int = DEFAULT_TEXT_SIZE,
    ...
    stem = _stem_vgroup(
        ...
        _T(" 和 ", font_size=ts),
        _M(r"\left(\frac{7}{2},3\right)", font_size=ms),
        _T("，则 ", font_size=ts),
        _M(r"C", font_size=ms),
...
def problem_11(text_size: int = DEFAULT_TEXT_SIZE,
    ...
    opt_b = _opt_vgroup(
        ...
        _T(" 与 ", font_size=opt_ts),
        _M("x", font_size=opt_ms),
        _T(" 轴的交点为 ", font_size=opt_ts),
        _M("(0,-k)", font_size=opt_ms),
    )
    opt_c = _opt_vgroup(
        _T("C. ", font_size=opt_ts),
        _T("当 ", font_size=opt_ts),
